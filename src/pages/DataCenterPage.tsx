...
const DataCenterPage: React.FC<DataCenterPageProps> = ({ darkMode }) => {
  ...
  const partners = [
    { src: '/src/images/datacenter/aws.png', alt: 'AWS' },
    { src: '/src/images/datacenter/Google_Cloud_logo.png', alt: 'Google Cloud' },
    { src: '/src/images/datacenter/IBM_logo.svg.png', alt: 'IBM' },
    { src: '/src/images/datacenter/NVIDIA_logo.svg.png', alt: 'NVIDIA' },
    { src: '/src/images/datacenter/aws.png', alt: 'AWS' },
    { src: '/src/images/datacenter/Google_Cloud_logo.png', alt: 'Google Cloud' }
  ];
  ...
  const networkLocations = [
    ...
    { location: 'Anz, Venezuela', code: 'C1' },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`p-8 rounded-2xl shadow-xl ${darkMode ? 'bg-gray-700' : 'bg-white'}`}>
              <img
                src="/src/images/datacenter/map-dark.svg"
